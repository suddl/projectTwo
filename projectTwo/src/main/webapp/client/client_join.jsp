...
<%-- => [아이디 중복 검사] 태그를 클릭한 경우 새창을 열어 [/client/id_check.jsp] 문서를 요청 - 아이디 전달 --%>
<%-- => [우편번호 검색] 태그를 클릭한 경우 [다음 우편번호 서비스]를 사용하여 입력태그(우편번호와 기본주소)의 입력값 변경 --%>    
<%-- => [회원가입] 태그를 클릭한 경우 [/client/cleint_join_action.jsp] 문서를 요청하여 페이지 이동 - 입력값 전달 --%>    
<style type="text/css">
fieldset {
	text-align: left;
	margin: 10px auto;
...
<%-- => [아이디 중복 검사] 태그를 클릭한 경우 새창을 열어 [/client/id_check.jsp] 문서를 요청 - 아이디 전달 --%>
<%-- => [우편번호 검색] 태그를 클릭한 경우 [다음 우편번호 서비스]를 사용하여 입력태그(우편번호와 기본주소)의 입력값 변경 --%>    
<%-- => [회원가입] 태그를 클릭한 경우 [/client/client_join_action.jsp] 문서를 요청하여 페이지 이동 - 입력값 전달 --%>    
<style type="text/css">
fieldset {
	text-align: left;
	margin: 10px auto;
...
</script>중복 검사] 태그를 클릭한 경우 호출되는 이벤트 처리 함수 등록
$("#idCheck").click(function() {
	//아이디 관련 에러메세지가 보여지지 않도록 설정
	$("#idMsg").css("display","none");
	$("#idRegMsg").css("display","none");
