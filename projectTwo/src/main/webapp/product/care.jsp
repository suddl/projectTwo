...
<%     
	...
	List<ProductDTO> productList=ProductDAO.getDAO().selectProductListByCategory(startRow, endRow, "CareTool");
...
<div class="prodList" id="prodList">
	...
	<div id="page_list">
		<%
			String responseUrl=request.getContextPath()+"/index.jsp?group=product&worker=care"
					+"&pageSize="+pageSize;
		%>
