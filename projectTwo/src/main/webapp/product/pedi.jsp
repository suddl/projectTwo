        ...
        <div class="product-list">
            <div class="product">
                ...
                <div class="product-name">
                    <a href="<%=request.getContextPath() %>/index.jsp?group=detail&worker=detail">피치 스톤 페디</a>
                </div>
                ...
                <div class="product-name">
                <a href="<%=request.getContextPath() %>/index.jsp?group=detail&worker=detail">헬로 선라이즈 페디</a></div>
            ...
            <div class="product">
                ...
                <div class="product-name">
                <a href="<%=request.getContextPath() %>/index.jsp?group=detail&worker=detail">글로우 블러쉬 페디</a></div>
            ...
            <div class="product">
                ...
                <div class="product-name">
                <a href="<%=request.getContextPath() %>/index.jsp?group=detail&worker=detail">슈가 프렌치 페디</a></div>
